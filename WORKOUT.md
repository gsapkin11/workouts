...
never repeats the previous 1-2 versions.
...
`logs/weekly-log.md`. The Strength Tracker table above is the permanent
lift history (the Notion page carries only the inline top-set blanks).
